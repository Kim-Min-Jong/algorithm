...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        long sum = 0;
        for(int i = 1; i <= V; i++) {
            sum += (long)depthVisited[i] * (long)visited[i];
        }
    ...
    static void dfs(ArrayList<Integer>[] list, int[] visited, int[] depthVisited, int root, int depth) {
